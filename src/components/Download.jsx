  ...
  return (
    <section className="relative w-full overflow-hidden" style={{ 
      ...
      <div className="w-full flex flex-col items-center px-4 sm:px-6">
        ...
        >
          Passionate on Ecommerce <br className="hidden sm:block"/>Business? <span className="font-metal text-6xl md:text-7xl lg:text-8xl xl:text-10xl md:whitespace-nowrap ">Try Comez</span>
        </h2>
