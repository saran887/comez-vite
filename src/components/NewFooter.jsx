...
const NewFooter = () => {
  return (
    <footer className="relative bg-black text-white pt-10 px-6 sm:px-6 md:px-20 lg:px-24 font-outfit overflow-hidden">
      {/* Top Left Gradient */}
      <div 
      ...
      <div className="container mx-auto relative z-10">
        <div className="flex flex-col md:flex-row md:justify-between md:pl-6 md:items-start">
